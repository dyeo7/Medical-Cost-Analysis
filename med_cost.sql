...
-- Distribution of Children Across Age Groups
...
-- Gender-Based Distribution of Smokers and Non-Smokers
SELECT i.sex, l.smoker, COUNT(*) AS "Total Count"
FROM g1.individuals i
JOIN g2.lifestyle l ON i.individual_id = l.individual_id
GROUP BY i.sex, l.smoker;

-- Average Costs by Sex and Smoker Status
SELECT 
    i.sex, 
    l.smoker, 
